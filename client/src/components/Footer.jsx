...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/saipranayk/", label: "LinkedIn" },
    { icon: <Instagram size={18} />, href: "#", label: "Instagram" },
    { icon: <Github size={18} />, href: "https://github.com/Mrksaipranay", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "k.saipranay6705@gmail.com", href: "mailto:k.saipranay6705@gmail.com" },
    { icon: <Phone size={16} />, text: "+91-9347596434", href: "tel:+919347596434" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">K. SAIPRANAY</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Full Stack Developer creating secure and scalable applications.
              </p>
          ...
          >
            <div>
              <p>© {currentYear} K. Saipranay. All rights reserved.</p>
            </div>
