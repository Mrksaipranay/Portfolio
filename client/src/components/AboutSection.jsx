...
export const AboutSection = () => {
  ...
  const achievements = [
    ...
    { number: "2025", label: "Graduating", icon: <Calendar className="h-5 w-5" />, suffix: "" },
    { number: "8.1", label: "CGPA", icon: <Target className="h-5 w-5" />, suffix: "/10" },
    { number: "6", label: "Certifications", icon: <User className="h-5 w-5" />, suffix: "+" }
  ];

  const techStack = [
    { category: "Languages", items: ["Java", "JavaScript", "Python", "HTML", "CSS", "SQL"] },
    { category: "Frameworks", items: ["React", "Node.js", "Express.js", "Angular", "Flask"] },
    { category: "Tools", items: ["Oracle Cloud", "Twilio API", "OpenCV", "REST APIs", "MySQL"] }
  ];

  const features = ["Full-stack development", "System security", "Database management", "UI/UX design", "Agile methodology", "Cloud services"];

  const socialLinks = [
    { icon: <Github className="h-5 w-5" />, href: "https://github.com/Mrksaipranay" },
    { icon: <Linkedin className="h-5 w-5" />, href: "https://www.linkedin.com/in/saipranayk/" },
    { icon: <Twitter className="h-5 w-5" />, href: "#" },
    { icon: <Mail className="h-5 w-5" />, href: "mailto:k.saipranay6705@gmail.com" }
  ];

  const tabContent = {
    personal: "Computer Science Engineering student at Saveetha School of Engineering with a CGPA of 8.1/10.0. Passionate about building secure and scalable applications. Graduating in November 2025 and eager to contribute to innovative projects.",
    professional: "Completed internship at Jyesta Corporate Entity Private Limited (May-Aug 2025) as Full Stack Developer. Developed responsive web applications, optimized databases, and integrated RESTful APIs. Built 3+ projects focusing on security and real-time systems.",
    approach: "I believe in writing clean, secure code with thorough testing. My focus areas include Full-Stack Development, System Security, Database Management, and Agile Methodologies. Always learning and adapting to new technologies."
  };
  ...
  const handleDownload = () => {
    ...
    link.href = '/K-Saipranay-resume.pdf'; // Must be in public folder
    link.download = 'K-Saipranay-resume.pdf';
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-2xl overflow-hidden border-4 border-primary/20 shadow-2xl transition-all duration-500 group-hover:border-primary/40 group-hover:scale-105 md:group-hover:scale-110 relative">
                      <img src="/profile-logo.png" alt="K. Saipranay" className="w-full h-full object-cover" />
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">K. Saipranay</h2>
