...
const projects = [
  {
    id: 1,
    title: "Location-Based Job Alert Application",
    category: "Mobile Application",
    description: "Mobile application delivering job alerts based on real-time geolocation with cloud infrastructure for storing job listings and user profiles.",
    image: "/projects/project1.png",
    video: "/projects/videos/job-alert-demo.mp4",
    tags: ["Mobile Development", "Cloud Services", "Geolocation", "Real-time Notifications", "Job Matching"],
    demoUrl: "#",
    githubUrl: "#",
    featured: true,
    accentColor: "from-blue-500 to-cyan-600",
    status: "Completed",
    highlights: ["Real-time geolocation alerts", "Cloud infrastructure", "Location tracking algorithms", "Job matching features"]
  },
  {
    id: 2,
    title: "Two-Factor Authentication System",
    category: "Security",
    description: "SMS-based OTP authentication system using Twilio with encrypted password storage and session management.",
    image: "/projects/project2.png",
    video: "/projects/videos/2fa-demo.mp4",
    tags: ["Python", "Flask", "Twilio API", "JavaScript", "Security", "OTP"],
    demoUrl: "#",
    githubUrl: "#",
    featured: true,
    accentColor: "from-emerald-500 to-teal-600",
    status: "Completed",
    highlights: ["SMS-based OTP authentication", "Encrypted password storage", "Session management", "OTP expiration handling"]
  },
  {
    id: 3,
    title: "Image & Audio Steganography System",
    category: "Security & Cryptography",
    description: "Data hiding system using LSB encoding with AES encryption for confidentiality and integrity checks.",
    image: "/projects/project3.png",
    video: "/projects/videos/steganography-demo.mp4",
    tags: ["Python", "OpenCV", "PyCryptodome", "Steganography", "AES Encryption", "GUI"],
    demoUrl: "#",
    githubUrl: "#",
    featured: true,
    accentColor: "from-purple-500 to-indigo-600",
    status: "Completed",
    highlights: ["LSB encoding for data hiding", "AES encryption integration", "GUI for encoding/decoding", "Data validation and integrity"]
  },
  {
    id: 4,
    title: "IoT WiFi Deauther for Mobile Addiction Control",
    category: "Hardware & IoT",
    description: "IoT-based hardware solution designed to help parents manage children's mobile addiction by controlling WiFi access through deauthentication attacks on specific devices.",
    image: "/projects/project4.png",
    video: "/projects/videos/wifi-deauther-demo.mp4",
    tags: ["IoT", "ESP8266", "WiFi Security", "Hardware", "Parental Control", "Network Management"],
    demoUrl: "#",
    githubUrl: "#",
    featured: true,
    accentColor: "from-orange-500 to-red-600",
    status: "Completed",
    highlights: ["Device-specific WiFi blocking", "ESP8266 microcontroller", "Web-based control interface", "Scheduled access control"]
  }
];

const categoryColors = {
  "Mobile Application": "from-blue-500/20 to-cyan-600/20 text-blue-600 border-blue-500/30",
  "Security": "from-emerald-500/20 to-teal-600/20 text-emerald-600 border-emerald-500/30",
  "Security & Cryptography": "from-purple-500/20 to-indigo-600/20 text-purple-600 border-purple-500/30",
  "Hardware & IoT": "from-orange-500/20 to-red-600/20 text-orange-600 border-orange-500/30"
};
