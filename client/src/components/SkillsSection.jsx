...
const skills = [
  // Languages
  { name: "Java", level: 85, category: "languages", icon: "java" },
  { name: "JavaScript", level: 90, category: "languages", icon: "javascript" },
  { name: "Python", level: 80, category: "languages", icon: "python" },
  { name: "HTML5", level: 90, category: "languages", icon: "html" },
  { name: "CSS3", level: 85, category: "languages", icon: "css" },
  { name: "SQL", level: 85, category: "languages", icon: "sql" },

  // Frameworks
  { name: "React", level: 85, category: "frameworks", icon: "react" },
  { name: "Node.js", level: 85, category: "frameworks", icon: "nodejs" },
  { name: "Express", level: 80, category: "frameworks", icon: "express" },
  { name: "Flask", level: 75, category: "frameworks", icon: "python" },

  // Tools & Technologies
  { name: "MySQL", level: 85, category: "tools", icon: "mysql" },
  { name: "PostgreSQL", level: 80, category: "tools", icon: "postgresql" },
...
const categories = [
  ...
  { id: "frameworks", label: "Frameworks", color: "bg-gradient-to-r from-green-500 to-emerald-500" },
  { id: "tools", label: "Tools & Tech", color: "bg-gradient-to-r from-orange-500 to-yellow-500" },
];
