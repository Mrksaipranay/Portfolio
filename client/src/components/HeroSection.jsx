...
export const HeroSection = () => {
  ...
  const codeSnippets = [
    "import { FullStackDeveloper } from 'saipranay.dev';",
    "",
    "const developer = new FullStackDeveloper({",
    "  name: 'K. Saipranay',",
    "  stack: ['React', 'Node.js', 'Angular', 'Flask', 'Python'],",
    "  focus: 'Building secure and scalable applications',",
    "  status: 'Open to new opportunities'",
    "});",
    "",
    "await developer.launchPortfolio();",
    "// Featured: Mobile Apps, Security Systems, Steganography",
    "",
    "developer.connect();",
  ...
  const achievements = [
    { number: "8.1", label: "CGPA", icon: <Shield className="h-3 w-3" /> },
    { number: "3+", label: "Projects Completed", icon: <TrendingUp className="h-3 w-3" /> },
    { number: "6", label: "Certifications", icon: <Award className="h-3 w-3" /> },
    { number: "Intern", label: "Experience", icon: <Zap className="h-3 w-3" /> }
  ];
  ...
  const handleViewResume = () => {
    ...
    window.open('/K-Saipranay-resume.pdf', '_blank', 'noopener,noreferrer');
  };
        ...
        <motion.div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-20" initial="hidden" animate={isInView ? "visible" : "hidden"} variants={{ hidden: { opacity: 0 }, visible: { opacity: 1, transition: { staggerChildren: 0.25, delayChildren: 0.5 } } }}>
          ...
          <div className="flex-1 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
            ...
            <motion.h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tight" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
              <span className="block text-foreground">I'm K. Saipranay</span>
            ...
            <motion.p className="text-lg sm:text-xl text-muted-foreground mt-6 leading-relaxed max-w-2xl" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
              Computer Science student at <span className="text-primary font-semibold">Saveetha School of Engineering</span> (CGPA: 8.1/10.0). Specializing in Full-Stack Development, System Security, and building scalable applications with modern technologies.
            </motion.p>
            ...
            <motion.div className="mt-6 text-center lg:text-left" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
              <div className="text-sm text-muted-foreground">
                🎓 <span className="text-primary font-semibold">Graduating Nov 2025</span> | Open to Full-Stack Developer roles
              </div>
            </motion.div>
          </div>
