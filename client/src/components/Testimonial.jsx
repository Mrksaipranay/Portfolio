  ...
  const testimonials = [
    {
      id: 1,
      name: "Rajesh Kumar",
      role: "Tech Lead at Jyesta Corporate",
      content: `Sai Pranay demonstrated exceptional skills during his internship. His work on the two-factor authentication system was impressive - clean code, robust security implementation, and excellent documentation. He's a quick learner who takes initiative.`,
      rating: 5,
    ...
    },
    {
      id: 2,
      name: "Priya Sharma",
      role: "Senior Developer at CloudTech Solutions",
      content: `Working with Sai Pranay on the job alert application was fantastic. His understanding of geolocation services and cloud infrastructure is remarkable for someone at his level. He delivers quality work consistently and communicates effectively.`,
      rating: 5,
    ...
    },
    {
      id: 3,
      name: "Arun Patel",
      role: "Project Manager at SecureApps Inc",
      content: `Sai Pranay's steganography project showcased his deep understanding of security concepts and cryptography. His ability to integrate complex algorithms like AES encryption with user-friendly interfaces is truly commendable. A talented developer with great potential.`,
      rating: 5,
