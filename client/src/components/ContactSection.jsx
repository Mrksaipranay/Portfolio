  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Please try again or email me directly at k.saipranay6705@gmail.com",
        variant: "destructive"
      });
    } finally {
                ...
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/saipranayk/",
                  },
                  {
                    icon: Twitter,
                    label: "Twitter",
                  ...
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/Mrksaipranay",
                  },
                  {
                    icon: Instagram,
                    label: "Instagram",
